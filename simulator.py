...
class TetrisSimulator(object):
    ...
    def __init__(self, board=None, curr=None, next=None, controller=None,
                 ...
                 show_choice=False, show_episodes=False,option_step=0, 
                 choice_step=0, name="Controller", seed=time.time(), 
        ...
        self.log_episodes = show_episodes
        ...
        self.filename = "episodes_" + datetime.now().strftime("%d-%m-%Y-%H-%M-%S")
        self.logdir = "data/episodes/"
    ...
    def printscores(self):
        ...
        print ("\t(1: %d  2: %d  3: %d  4: %d)" %(self.l[1], self.l[2], self.l[3], self.l[4]))
        print
    ...
    def label_zoid(self,zoid):
        """ Gets the name of the zoid """
    	for name, tetris_zoid in all_zoids.iteritems():
    		if tetris_zoid == zoid:
    			return name
